...
globalScope['quasiquote'] = new Macro(function($block){ 
	return thunk($block.definingScope || this, expandQuasiQuote($block.definingScope, $block))
});
...
globalScope['.attribute'] = function(s){ return new AttributeName(s) }
