module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c4 = function(begins, inside, ends) { 
        ...
        peg$c7 = function() { return offset },
        peg$c8 = "]",
        peg$c9 = { type: "literal", value: "]", description: "\"]\"" },
        peg$c10 = "'",
        peg$c11 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c12 = function(it) { return [new Reference('quote'), it] },
        peg$c13 = "`",
        peg$c14 = { type: "literal", value: "`", description: "\"`\"" },
        peg$c15 = function(it) { return [new Reference('quasiquote'), it] },
        peg$c16 = ",",
        peg$c17 = { type: "literal", value: ",", description: "\",\"" },
        peg$c18 = function(it) { return [new Reference('unquote'), it] },
        peg$c19 = "{",
        peg$c20 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c21 = "}",
        peg$c22 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c23 = function(inside) {
        		return inside
        	},
        peg$c24 = function(inner) { return formBlock(inner) },
        peg$c25 = void 0,
        peg$c26 = function(bc) { return bc },
        ...
        peg$c30 = function(leader, rear) { 
        	return leader.concat([formBlock(rear)])
        },
        peg$c31 = "|",
        peg$c32 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c33 = function(leader, leadingSpaces, rear) {
        ...
        peg$c53 = function(it) { return [new Reference('.verbatim'), it] },
        peg$c54 = "\\",
        peg$c55 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c56 = /^[+#\-=`*:[\]{}\\]/,
        peg$c57 = { type: "class", value: "[+#\\-=`*:[\\]{}\\\\]", description: "[+#\\-=`*:[\\]{}\\\\]" },
        peg$c58 = function(special) { return [new Reference('.lit'), special]},
        peg$c59 = function(normal) { return [new Reference('.lit'), '\\' + normal] },
        peg$c60 = { type: "other", description: "Text" },
        peg$c61 = /^[^\r\n[{\\}\]*`]/,
        peg$c62 = { type: "class", value: "[^\\r\\n[{\\\\}\\]*`]", description: "[^\\r\\n[{\\\\}\\]*`]" },
        peg$c63 = function(t) { return [new Reference('.lit'), t] },
        peg$c64 = "**",
        peg$c65 = { type: "literal", value: "**", description: "\"**\"" },
        peg$c66 = function(inner) { return [new Reference('.inline**'), formLine(inner)] },
        peg$c67 = "*",
        peg$c68 = { type: "literal", value: "*", description: "\"*\"" },
        peg$c69 = function(inner) { return [new Reference('.inline*'), formLine(inner)] },
        peg$c70 = { type: "other", description: "String Literal" },
        peg$c71 = "\"",
        peg$c72 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c73 = function(inner) { return inner.join('') },
        peg$c74 = /^[^"\\\r\n]/,
        peg$c75 = { type: "class", value: "[^\"\\\\\\r\\n]", description: "[^\"\\\\\\r\\n]" },
        peg$c76 = "\\u",
        peg$c77 = { type: "literal", value: "\\u", description: "\"\\\\u\"" },
        peg$c78 = /^[a-fA-F0-9]/,
        peg$c79 = { type: "class", value: "[a-fA-F0-9]", description: "[a-fA-F0-9]" },
        peg$c80 = function(digits) { 
        		return String.fromCharCode(parseInt(digits.join(''), 16))
        	},
        peg$c81 = /^[^u\r\n]/,
        peg$c82 = { type: "class", value: "[^u\\r\\n]", description: "[^u\\r\\n]" },
        peg$c83 = function(which) {
        		switch(which) {
        			case('n'): return "\n"
        			case('r'): return "\r"
        			case('"'): return "\""
        ...
        peg$c85 = { type: "other", description: "Code Span" },
        peg$c86 = /^[^`]/,
        ...
        peg$c102 = function(content) { return content },
        peg$c103 = function(terminator) { 
        		return terminator === storedVerbatimTerminator
        	},
        peg$c104 = function(terminator) { return },
        peg$c105 = "=",
        peg$c106 = { type: "literal", value: "=", description: "\"=\"" },
        peg$c107 = function(equals) { return equals },
        peg$c108 = { type: "other", description: "Numeric Literal" },
        peg$c109 = function(positive) { return -positive },
        peg$c110 = "0x",
        peg$c111 = { type: "literal", value: "0x", description: "\"0x\"" },
        peg$c112 = "0X",
        peg$c113 = { type: "literal", value: "0X", description: "\"0X\"" },
        peg$c114 = /^[0-9a-fA-F]/,
        peg$c115 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c116 = function(hexdigits) { return parseInt(hexdigits, 16) },
        peg$c117 = /^[0-9]/,
        ...
        peg$c125 = function(decimal) { return decimal - 0 },
        peg$c126 = { type: "other", description: "Identifier" },
        peg$c127 = /^[a-zA-Z\-_\/+*<=>!?$%_&~\^@#]/,
        peg$c128 = { type: "class", value: "[a-zA-Z\\-_\\/+*<=>!?$%_&~\\^@#]", description: "[a-zA-Z\\-_\\/+*<=>!?$%_&~\\^@#]" },
        peg$c129 = /^[a-zA-Z0-9.\-_\/+*<=>!?$%_&~\^@#]/,
        peg$c130 = { type: "class", value: "[a-zA-Z0-9.\\-_\\/+*<=>!?$%_&~\\^@#]", description: "[a-zA-Z0-9.\\-_\\/+*<=>!?$%_&~\\^@#]" },
        peg$c131 = function(it) { 
        		var ref = new Reference(it);
        //		ref.line = line();
        //		ref.column = column();
        		return ref;
        	},
        peg$c132 = { type: "other", description: "Embedded Identifier" },
        peg$c133 = /^[a-zA-Z_$]/,
        peg$c134 = { type: "class", value: "[a-zA-Z_$]", description: "[a-zA-Z_$]" },
        peg$c135 = /^[a-zA-Z0-9_]/,
        peg$c136 = { type: "class", value: "[a-zA-Z0-9_]", description: "[a-zA-Z0-9_]" },
        peg$c137 = function(it) { return new Reference(it) },
        peg$c138 = { type: "other", description: "Space Character" },
        peg$c139 = /^[\t\x0B\f \xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\uFEFF]/,
        peg$c140 = { type: "class", value: "[\\t\\x0B\\f \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000\\uFEFF]", description: "[\\t\\x0B\\f \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000\\uFEFF]" },
        peg$c141 = { type: "other", description: "Space Character or Newline" },
        peg$c142 = /^[\t\x0B\f \xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\uFEFF\r\n]/,
        peg$c143 = { type: "class", value: "[\\t\\x0B\\f \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000\\uFEFF\\r\\n]", description: "[\\t\\x0B\\f \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000\\uFEFF\\r\\n]" },
        ...
        peg$c149 = { type: "other", description: "Paragraph Break" },
        peg$c150 = { type: "other", description: "Single Newline" },
