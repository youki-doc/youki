...
PropertyList.prototype.toString = function(){ return this.props.join(' ') }
...
exports.apply = function(scope, runtime){
	...
	scope.tag = function(tagname, h, b){
		if(arguments.length < 2 && !(h instanceof PropertyList)){
			b = h, h = ''
		};
		b = ((b || '') + '');
		h = ((h || '') + '').trim();
	...
	scope['html-properties'] = new runtime.Macro(function(){
		var buff = [];
